package mx.com.curso.commons.aspects;

import mx.com.curso.commons.exceptions.ForbiddenException;
import mx.com.curso.commons.exceptions.NotFoundException;
import mx.com.curso.commons.exceptions.ParametersException;
import mx.com.curso.commons.exceptions.UnauthorizedException;
import mx.com.curso.commons.to.ErrorTO;
...
public class RequestValidatorAspect {
    ...
    @Around(value = "execution(* mx.com.curso.web.rest.*.*(..))  && args(..)")
